 ...
 */
  ...
  */
  public deleteFavorite(userName: string, movieID: any): Observable<any> {
   ...
   /**
  * Sends a GET request to conult a list of favourites movies according to the logged in user.
  * @param userName Username of the logged in user.
  * @returns A  render version of the list of favourites similar to the one obtainer in movie-card.component
  * with the same toggle functino to remove the movie from the list and update the UI.
  */
